// ========================================================
// Copyright https://github.com/aaronmjacobs/Boxer
// ========================================================
...
bool utf8ToUtf16(const char* utf8String, std::wstring& utf16String) {
    ...
    return MultiByteToWideChar(CP_UTF8, 0, utf8String, -1, &utf16String[0],
                               count) > 0;
}
...
Selection show(const char* message, const char* title, Style style,
    ...
    return getSelection(MessageBox(nullptr, messageArg, titleArg, flags),
                        buttons);
}
