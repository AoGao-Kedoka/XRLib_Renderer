...
class Events {
   public:
    // Application events
    inline static std::string XRLIB_EVENT_APPLICATION_INIT_STARTED{"application_prepare_started"};
    inline static std::string XRLIB_EVENT_APPLICATION_INIT_FINISHED{"application_prepare_finished"};
